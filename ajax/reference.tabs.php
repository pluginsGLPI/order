   ...
   if (!empty($_POST["withtemplate"])) {
		...
		switch($_REQUEST['glpi_tab']) {
         ...
         "/plugins/order/front/reference_supplier.form.php",$_POST["id"]);
            $PluginOrderReference_Supplier->showForm("", array('plugin_order_references_id' => $_POST["id"], 'target' => $CFG_GLPI["root_doc"] .
         "/plugins/order/front/reference_supplier.form.php"));
