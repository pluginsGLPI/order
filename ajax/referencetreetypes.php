      ...
      if ($result=$DB->query($query)) {
         if ($DB->numrows($result)) {
            ...
            while ($row = $DB->fetch_array($result)) {
               ...
               $path['href'] = $CFG_GLPI["root_doc"]."/plugins/order/front/$target?is_deleted=0&field[0]=3&searchtype[0]=equals&contains[0]=".rawurlencode($class)."&$link&itemtype=PluginOrderReference&start=0";
