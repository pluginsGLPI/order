-- 
-- Table `glpi_plugin_order_orders`
-- 
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_order_orders` (
   ...
   `plugin_order_orderstates_id` int (11)  NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_order_orderstates (id)',
   ...
   KEY `plugin_order_orderstates_id` (`plugin_order_orderstates_id`),
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_orders_items`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_references`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_orders_suppliers`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_surveysuppliers`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_others`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_othertypes`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_profiles`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_configs`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_billstates`
-- 
...
-- --------------------------------------------------------
-- 
-- Table `glpi_plugin_order_billtypes`
-- 
